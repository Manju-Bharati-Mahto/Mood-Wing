...
const emotionEmojis: Record<Emotion, string> = {
  neutral: '📝', angry: '🔥', sad: '🌧️', happy: '🌸', anxious: '💫', fearful: '👻',
  manic: '⚡', confused: '🌀', frustrated: '💢', lonely: '🌙', peaceful: '🍃',
  grateful: '🙏', hopeful: '🌅', loving: '💕', proud: '🏆', excited: '🎉',
  amused: '😄', content: '☕', jealous: '💚', guilty: '⚖️', ashamed: '😔',
  disgusted: '🤢', bitter: '🍋', resentful: '😤', envious: '👀', nostalgic: '📷',
  melancholic: '🌑', contemplative: '🧘', curious: '🔍', bored: '😐', apathetic: '💤',
  ecstatic: '✨', devastated: '💔', furious: '🌋', terrified: '😱', awestruck: '🤩'
};

export function EmotionCollection({ entries, onDelete, isOpen = false, onOpenChange }: EmotionCollectionProps) {
                ...
                <div className="space-y-3">
                  {entries.map((entry, index) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1, x: 0, rotateZ: (index % 3 - 1) * 1.5 }}
                    ...
                    >
                      ...
                      <p className="text-sm text-foreground/80 leading-relaxed line-clamp-4">{entry.text}</p>
                    </motion.div>
                  ))}
                </div>
              )}
